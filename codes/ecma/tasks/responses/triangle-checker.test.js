const triangleChecker = require('./triangle-checker')
...
test('checking if triangle is isosceles', () => {
...
test('checking if triangle is scalene', () => {
...
test('checking if triangle is invalid', () => {
